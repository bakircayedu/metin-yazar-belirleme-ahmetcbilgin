...
// BTK Akademi Zafer Cömert -Algoritma ve Veri Yapıları İleri Seviye kursundan yararlanılmıştır.
...
namespace VYProje
{
        ...
        where T : IComparable
    {
        ...
        public T Peek()
        {
            if (IsEmpty())
            {
                throw new Exception("Boştur boştur!");
            }
            return Array[0];
        }
